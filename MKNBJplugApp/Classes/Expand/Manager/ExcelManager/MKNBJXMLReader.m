...
@implementation MKNBJXMLReader

#pragma mark - Public methods

+ (NSDictionary *)dictionaryForXMLData:(NSData *)data error:(NSError **)error
{
    MKNBJXMLReader *reader = [[MKNBJXMLReader alloc] initWithError:error];
...
+ (NSDictionary *)dictionaryForXMLString:(NSString *)string error:(NSError **)error
{
    ...
    return [MKNBJXMLReader dictionaryForXMLData:data error:error];
}
...
{
    NSData *data = [string dataUsingEncoding:NSUTF8StringEncoding];
    return [MKNBJXMLReader dictionaryForXMLData:data options:options error:error];
}
