//
//  MKNBJMQTTSettingForDeviceCell.m
...
@implementation MKNBJMQTTSettingForDeviceCellModel
...
@interface MKNBJMQTTSettingForDeviceCell ()
...
@implementation MKNBJMQTTSettingForDeviceCell

+ (MKNBJMQTTSettingForDeviceCell *)initCellWithTableView:(UITableView *)tableView {
    MKNBJMQTTSettingForDeviceCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKNBJMQTTSettingForDeviceCellIdenty"];
    if (!cell) {
        cell = [[MKNBJMQTTSettingForDeviceCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKNBJMQTTSettingForDeviceCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKNBJMQTTSettingForDeviceCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKNBJMQTTSettingForDeviceCellModel.class]) {
        return;
    }
