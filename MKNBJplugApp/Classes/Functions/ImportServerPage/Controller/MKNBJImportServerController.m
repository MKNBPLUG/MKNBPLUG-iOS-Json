...
@interface MKNBJImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKNBJImportServerController

- (void)dealloc {
    NSLog(@"MKNBJImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(nbj_selectedServerParams:)]) {
        [self.delegate nbj_selectedServerParams:model.leftMsg];
    }
