...
@interface MKNBJDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKNBJDFUModule

- (void)dealloc{
    NSLog(@"MKNBJDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKNBJCentralManager shared].peripheral];
}
