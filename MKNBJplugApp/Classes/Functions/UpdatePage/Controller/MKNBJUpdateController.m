...
@interface MKNBJUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKNBJDFUModule *dfuModule;
...
@implementation MKNBJUpdateController

- (void)dealloc {
    NSLog(@"MKNBJUpdateController销毁");
...
- (void)updateComplete {
    ...
    [MKNBJCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_nbj_centralDeallocNotification" object:nil];
...
- (MKNBJDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKNBJDFUModule alloc] init];
    }
    return _dfuModule;
}
