...
@implementation MKNBJEasyShowView
...
- (void)showText:(NSString *)text
    ...
    if (animated) {
        ...
        [self.refreshIcon.layer addAnimation:[MKCustomUIAdopter refreshAnimation:1.f]
                                      forKey:@"mk_nbj_refreshAnimation"];
    }else {
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"MKNBJplugApp", @"MKNBJEasyShowView", @"nbj_refreshIcon.png");
    }
    return _refreshIcon;
}
