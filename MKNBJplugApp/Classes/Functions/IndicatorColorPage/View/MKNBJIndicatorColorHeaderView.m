//
//  MKNBJIndicatorColorHeaderView.m
...
@interface MKNBJIndicatorColorHeaderViewModel : NSObject
...
@implementation MKNBJIndicatorColorHeaderViewModel
@end

@interface MKNBJIndicatorColorHeaderView ()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation MKNBJIndicatorColorHeaderView
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view{
    ...
    MKNBJIndicatorColorHeaderViewModel *model = self.dataList[row];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component{
    ...
    if ([self.delegate respondsToSelector:@selector(nbj_colorSettingPickViewTypeChanged:)]) {
        [self.delegate nbj_colorSettingPickViewTypeChanged:model.colorType];
    }
}
...
- (void)updateColorType:(NSInteger)colorType {
    ...
    for (NSInteger i = 0; i < self.dataList.count; i ++) {
        MKNBJIndicatorColorHeaderViewModel *model = self.dataList[i];
...
- (void)loadPickViewDatas {
    MKNBJIndicatorColorHeaderViewModel *transitionDirectlyModel = [[MKNBJIndicatorColorHeaderViewModel alloc] init];
    ...
    MKNBJIndicatorColorHeaderViewModel *transitionSmoothlyModel = [[MKNBJIndicatorColorHeaderViewModel alloc] init];
    ...
    MKNBJIndicatorColorHeaderViewModel *whiteModel = [[MKNBJIndicatorColorHeaderViewModel alloc] init];
    whiteModel.colorMsg = @"White";
    whiteModel.colorType = 2;
    [self.dataList addObject:whiteModel];
    
    MKNBJIndicatorColorHeaderViewModel *redModel = [[MKNBJIndicatorColorHeaderViewModel alloc] init];
    redModel.colorMsg = @"Red";
    redModel.colorType = 3;
    [self.dataList addObject:redModel];
    
    MKNBJIndicatorColorHeaderViewModel *greenModel = [[MKNBJIndicatorColorHeaderViewModel alloc] init];
    greenModel.colorMsg = @"Green";
    greenModel.colorType = 4;
    [self.dataList addObject:greenModel];
    
    MKNBJIndicatorColorHeaderViewModel *blueModel = [[MKNBJIndicatorColorHeaderViewModel alloc] init];
    blueModel.colorMsg = @"Blue";
    blueModel.colorType = 5;
    [self.dataList addObject:blueModel];
    
    MKNBJIndicatorColorHeaderViewModel *orangeModel = [[MKNBJIndicatorColorHeaderViewModel alloc] init];
    orangeModel.colorMsg = @"Orange";
    orangeModel.colorType = 6;
    [self.dataList addObject:orangeModel];
    
    MKNBJIndicatorColorHeaderViewModel *cyanModel = [[MKNBJIndicatorColorHeaderViewModel alloc] init];
    cyanModel.colorMsg = @"Cyan";
    cyanModel.colorType = 7;
    [self.dataList addObject:cyanModel];
    
    MKNBJIndicatorColorHeaderViewModel *purpleModel = [[MKNBJIndicatorColorHeaderViewModel alloc] init];
