...
@implementation MKNBJSwitchViewButtonModel
@end

@interface MKNBJSwitchViewButton ()
...
@implementation MKNBJSwitchViewButton
...
#pragma mark - setter
- (void)setDataModel:(MKNBJSwitchViewButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKNBJSwitchViewButtonModel.class]) {
        return;
    }
