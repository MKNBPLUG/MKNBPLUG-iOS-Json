...
@implementation MKNBJCountdownPickerViewModel
@end

@interface MKNBJCountdownPickerView()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@property (nonatomic, copy)void (^timePickerBlock)(MKNBJCountdownPickerViewModel *timeModel);
...
@implementation MKNBJCountdownPickerView

- (void)dealloc{
    NSLog(@"MKNBJCountdownPickerView销毁");
}
