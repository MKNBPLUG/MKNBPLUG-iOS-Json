...
@interface MKNBJPeripheral ()

@property (nonatomic, strong)CBPeripheral *peripheral;

@end

@implementation MKNBJPeripheral
...
- (void)updateCharacterWithService:(CBService *)service {
    [self.peripheral nbj_updateCharacterWithService:service];
}

- (void)updateCurrentNotifySuccess:(CBCharacteristic *)characteristic {
    [self.peripheral nbj_updateCurrentNotifySuccess:characteristic];
}

- (BOOL)connectSuccess {
    return [self.peripheral nbj_connectSuccess];
}

- (void)setNil {
    [self.peripheral nbj_setNil];
}
