...
/**
 线程ID
 */
@property (nonatomic, assign)mk_nbj_taskOperationID operationID;
...
- (instancetype)initOperationWithID:(mk_nbj_taskOperationID)operationID
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKNBJTaskAdopter parseReadDataWithCharacteristic:characteristic]];
}

- (void)peripheral:(CBPeripheral *)peripheral didWriteValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKNBJTaskAdopter parseWriteDataWithCharacteristic:characteristic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_nbj_taskOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_nbj_defaultTaskOperationID || operationID != self.operationID) {
        return;
    }
